...
Source Host           : 123.56.179.55:3306
Source Database       : pk_db

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2017-04-01 13:05:25
*/
...
CREATE TABLE `pk_bank` (
  ...
  `realname` varchar(255) DEFAULT NULL COMMENT '开户人姓名',
  `bindphone` varchar(11) DEFAULT NULL COMMENT '开户人绑定手机号',
  `cardno` varchar(225) DEFAULT NULL COMMENT '银行卡号',
  `bankaddress` varchar(255) DEFAULT NULL,
  `banktype` tinyint(2) DEFAULT NULL COMMENT '银行卡类型(1，中国农业银行)',
  `usertype` tinyint(2) DEFAULT '0' COMMENT '用户类型（0,普通会员；1,平台银行卡【不需要绑定uid哦】）',
  `addtime` int(10) DEFAULT NULL,
  `isdefault` tinyint(2) DEFAULT '0' COMMENT '平台银行卡（1，默认收款账户）',
  PRIMARY KEY (`id`)
...
-- Records of pk_bank
-- ----------------------------
INSERT INTO `pk_bank` VALUES ('6', null, '平台', '13007120000', '666888999', '北京市延庆区军都山关沟古道北口', '1', '1', '1488128509', '1');
...
-- ----------------------------
INSERT INTO `pk_config` VALUES ('1', '前程ABC/FUTURE-ABC', 'www.FUTURE-ABC.com', 'A级会员,B级会员,C级会员', 'A级会员:2:1000:24,B级会员:2-4-6-8:200-200-200-400:72,C级会员:4-6-8-10:200-200-200-400:72', '80.00', '24', '平台银行卡', '13007120000', '66666', '北京市延庆区军都山关沟古道北口', '1', '1491023109', '0');
